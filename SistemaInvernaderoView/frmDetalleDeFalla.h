...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Size = System::Drawing::Size(459, 175);
			...
			// Column2
			// 
			this->Column2->HeaderText = L"Nombre del Dispositivo";
			this->Column2->Name = L"Column2";
			// 
			// Column3
			// 
			this->Column3->HeaderText = L"Descripción de la falla";
			...
			this->label1->Size = System::Drawing::Size(217, 18);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Se hallaron las siguientes fallas:";
			// 
			// frmDetalleDeFalla
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(518, 263);
